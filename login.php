...
<head>
    ...
    * {
    ...
    .form {
        width: 400px;
        background-image: url('src/img/Officepicture.jpg');
    ...
    <div style="min-height: 100vh;"
        ...
        <div class="bg-success p-5">
            <form action="" method="post" class="form p-5 col-12 col-lg-4 bg-white rounded">
                <img class="d-block mx-auto" style="width: 80%;" src="src/img/swLogo.png">
                <div class="container my-3">
                    <label class="form-label" for="email">Email</label>
                    <input autofocus placeholder="Email" value="<?php echo $_POST['email'] ?? null ?>" required type="text" class="form-control form-control-sm input" id="email"
                        name="email">
                </div>
                <div class="container my-3">
                    <label class="form-label" for="password">Password</label>
                    <div class="d-block position-relative">
                        <input placeholder="Password" value="<?php echo $_POST['password'] ?? null ?>" required type="password" class="form-control form-control-sm input"
        ...
        <form action="" method="post" class="form p-5 col-12 col-lg-4 shadow" style="background: #fff; width: 500px;">
            ...
            <div class="container my-3">
                <input placeholder="Enter code" value="<?php echo $_POST[ 'otp' ] ?? null ?>" required type="number"
