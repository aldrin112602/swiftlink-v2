<div class="col d-flex align-items-center justify-content-end gap-4">
    ...
    <div class="bg-white text-center d-flex align-items-center justify-content-center" style="border-radius: 50px; flex-direction: column; height: 60px; width: 400px; line-height: -50px; position: relative;">
        ...
        ?>
        <img id="profile" alt="Profile" src="<?= $user['profile'] ?? 'https://www.oneeducation.org.uk/wp-content/uploads/2020/06/cool-profile-icons-69.png'  ?>" class="rounded-circle" style="position: absolute; right: 7px; height: 50px; width: 50px; top: 50%; transform: translateY(-50%); cursor: pointer;">
