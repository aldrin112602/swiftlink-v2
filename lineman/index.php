                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse " id="navbarSupportedContent">
                        ...
                        <ul class="navbar-nav flex-column justify-content-start">
                            ...
                            <li class="mt-5 d-grid">
                                <?php require_once '../admin/logout_confirmation.php'; ?>
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerse-widget">
                        ...
                        <div class="d-lg-flex d-block justify-content-between container mx-auto">
                            <div class="d-flex align-items-center justify-content-start bg-white px-3 py-2 gap-2 mt-3" style="border-radius: 30px; min-width: calc(100%/5);">
