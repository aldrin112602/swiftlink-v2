                        ...
                        <div class="row gap-5 justify-content-start px-md-5">
                            <a href="./package.php" class="col-12 col-lg-5 bg-white shadow p-5" style="border-radius: 40px;">
                                ...
                                <div class="container-fluid p-0 position-relative">
                                    ...
                                    <div style="height: 50px; width: 50px; position: absolute; top: 50%; right: 10px; transform: translateY(-50%);" class="container-fluid p-0 d-flex align-items-center justify-content-center bg-primary rounded-circle">
                            ...
                            <a href="./history.php" class="col-12 col-lg-5 bg-white shadow p-5" style="border-radius: 40px;">
                                ...
                                <div class="container-fluid p-0 position-relative">
                                    ...
                                    <div style="height: 50px; width: 50px; position: absolute; top: 50%; right: 10px; transform: translateY(-50%);" class="container-fluid p-0 d-flex align-items-center justify-content-center bg-warning rounded-circle">
                            ...
                            <a href="./open_ticket.php" class="col-12 col-lg-5 bg-white shadow p-5" style="border-radius: 40px;">
                                ...
                                <div class="container-fluid p-0 position-relative">
                                    ...
                                    <div style="height: 50px; width: 50px; position: absolute; top: 50%; right: 10px; transform: translateY(-50%);" class="container-fluid p-0 d-flex align-items-center justify-content-center bg-info rounded-circle">
                                        <span class="material-symbols-outlined text-white">
                                            receipt
                                        </span>
                                    </div>
