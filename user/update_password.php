                    ...
                    <div class="ecommerse-widget">
                        ...
                        <h3 class="my-2 pb-2">Update Password*</h3>
                            <div class="container my-3">
                                ...
                                <input autofocus value="<?php echo $_POST['current_password'] ?? null ?>" required
                                    type="text" class="form-control form-control-sm input" id="current_password" name="current_password">
                            </div>
                            <div class="container my-3">
                                <label class="form-label" for="password">Password</label>
                                <input value="<?php echo $password ?? null ?>" required
                                    type="password" class="form-control form-control-sm input" id="password"
                                    name="password">
                            </div>
                            <div class="container my-3">
                                <label class="form-label" for="confirm_password">Confirm Password</label>
                                <input value="<?php echo $confirm_password ?? null ?>" required
                                    type="password" class="form-control form-control-sm input" id="confirm_password"
