                            ...
                            <div class="row gap-5 justify-content-center">
                                ...
                                <div class="col-12 col-lg-5 bg-white shadow p-4 " style="border-radius: 40px;">
                                    ...
                                    <div class="container my-2">
                                        ...
                                        <input value="<?= $data['account_no'] ?? null ?>" type="number" class="form-control form-control-sm input" readonly>
                                    </div>

                                    <div class="container my-2">
                                        <label class="form-label">Name</label>
                                        <input value="<?= $_SESSION['name'] ?? null ?>" type="text" class="form-control form-control-sm input" readonly>
                                    </div>

                                    <div class="container my-2">
                                        <label class="form-label">Email</label>
                                        <input value="<?= $data['email'] ?? null ?>" type="email" class="form-control form-control-sm input" readonly>
                                    </div>

                                    <div class="container my-2">
                                        <label class="form-label">Address</label>
                                        <input value="<?= $data['address'] ?? null ?>" type="text" class="form-control form-control-sm input" readonly>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ecommerse-widget">
                            ...
                            <form action="" method="POST" class="bg-white p-2 p-md-5" style="border-radius: 40px;">
                                ...
                                <div class="col-12 mt-5">
                                    ...
                                    <a href="./package.php" class="btn btn-danger btn-lg px-5 text-white mx-3" style="border-radius: 20px;">Cancel</a>
                                </div>
                            </form>
                        </div>
                    <?php
