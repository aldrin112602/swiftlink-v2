                    ...
                    <div class="ecommerse-widget">
                        ...
                        <div class="container-fluid">
                            <div class="row gap-lg-5 gap-3 justify-content-betwen">
                                ...
                                <div id="col3" class="col-lg-5 col bg-white shadow px-3 py-3" style="display: none; border-radius: 25px;">
                                    <h3>Select Report</h3>
                                    <div>
                                        <select class="form-select" style="border-radius: 13px;" id="topicReport"></select>
                                    </div>
                                </div>
                                <div id="col4" class="col-11 bg-white shadow px-3 py-3 position-relative" style="display: none; min-height: 300px; border-radius: 25px;"></div>
                                <?php
                                ...
                                ?>
                                <form enctype="multipart/form-data" method="post" action="" id="col5" class=" col-11 bg-white shadow px-3 py-3 position-relative" style="display: none; min-height: 300px; border-radius: 25px;">
                                    <?php
