                        ...
                        <ul class="navbar-nav flex-column justify-content-start">
                            ...
                            <li class="nav-item my-1 current-page">
                                <a href="payment_confirmation.php"
                                    class=" d-flex align-items-center justify-content-start ml-4 fs-6">
                ...
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="container-fluid <?= isset($_GET['payment_confirmation']) ? 'd-none' : '' ?>">
                        ...
                        <div class="d-block d-md-flex justify-content-between align-items-center gap-3">
                            <button id="printBtn" class="btn mt-3"
                                style="border: 1px solid lime; border-radius: 10px;background: white;"><i
                                            ...
                                            <td>
                                                <a href="../user/<?= $row['image_path'] ?? null ?>">
                                                    <img width="50px" height="40px"
                                                        src="../user/<?= $row['image_path'] ?? null ?>" alt="">
                                                </a>
                                            </td>
                                            <td><?= $row['status'] ?? null ?></td>
                                            <td>
                                                <a href="?payment_confirmation=<?= $row['invoice'] ?? null ?>"
                                                    class="fas fa-eye fs-6 text-dark btn btn-sm"></a>
                                                <!-- 
                                                function `deleteConfirmation` is at the bottom, 
                                                please see t*nga ka pa naman 
                                            -->
                                                <button class="fa-solid fa-trash-can fs-6 text-danger btn btn-sm"
                                                    onclick="deleteConfirmation(<?= $row['id'] ?>, 'payment_confirmation')"></button>
                                            </td>
                                        </tr>
                                        <?php
                                $count++;
                    ...
                    ?>
                        <div class=" bg-white d-block d-lg-flex align-items-center justify-content-start"
                            style="border-radius: 50px;">
                            <div class="col">
                                <div class="p-5">
                                    <h3 class="fw-bold">Payment Confirmation</h3>
                                    <div class="alert alert-primary alert-dismissible fade show <?= $row['status'] == 'Approved' ? '' : "d-none" ?> pb-3"
                                        role="alert">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input readonly value="<?= $row['payment_method'] ?>" type="text"
                                            class="form-control" id="payment_method">
                                    </div>
                                    <div class="mb-3">
                                        <label for="date_payment" class="form-label">Date Payment</label>
                                        <input readonly value="<?= $row['date_payment'] ?>" type="text"
                                            class="form-control" name="date_payment" id="date_payment">
                                    </div>
                                    <div class="mb-3 <?= $row['status'] == 'Approved' ? 'd-none' : '' ?>">
                                        <button id="deny_btn" class="btn btn-danger px-5 btn-lg"
                                            style="border-radius: 15px;">Deny</button>

                                        <button id="verify_btn" type="submit" class="btn btn-primary mx-3 px-5 btn-lg"
                                            style="border-radius: 15px;">Verify</button>
                                        <script>
                                        $(document).ready(() => {
                            ...
                            <div class="col p-5 d-flex align-items-center justify-content-start">
                                <img id="preview" alt="" src="../user/<?= $row['image_path'] ?>"
                                    style="height: 600px; width: 80%; border-radius: 50px; border: 4px dashed rgba(0,0,0,0.3);">
                            </div>
                        </div>
                    </div>
