                    ...
                    <div class="container-fluid">
                        ...
                        <div class="container-fluid bg-white p-2 p-md-5" style="border-radius: 40px;">
                                ...
                                <div class="col-6 col-lg-4">
                                    ...
                                    <select class="form-select" id="filter">
                                        ...
                                        <option value="Process"
                                            <?= ($_GET['filter'] ?? null) == 'Process' ? 'selected' : '' ?>>Process
                                        </option>
                                        <option value="Done"
                                            <?= ($_GET['filter'] ?? null) == 'Done' ? 'selected' : '' ?>>Done
                                        </option>
                                        <option value="Pending"
                                            <?= ($_GET['filter'] ?? null) == 'Pending' ? 'selected' : '' ?>>Pending
                                        </option>
                            ...
                            <div class="table-responsive">
                                <table id="table" class="table table-white table-striped table-hover"
                        ...
                        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                            $post = validate_post_data($_POST);
                                ...
                                If you have any questions or need further assistance, please don't hesitate to reach out to us at swiftlink@gmail.com.<br>
                                <br><br>
                                Best regards,<br>
