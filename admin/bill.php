                        ...
                        ?>
                            <div class="table-responsive bg-white p-2 p-md-5" style="border-radius: 40px;">
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-4">
                                    <button style="border-radius: 15px;" class="btn btn-success btn-sm" data-bs-toggle="modal" data-bs-target="#disconnectionNotice">Make Disconnection Notice</button>
                                ...
                                <div class="modal fade" id="disconnectionNotice" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="disconnectionNoticeLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h1 class="modal-title fs-5" id="disconnectionNoticeLabel">Disconnection Notice</h1>
                                                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                            </div>
                                            <div class="modal-body p-0">
                                                <strong class="p-2 d-block">Select user</strong>
                                    ...
                                    <div class="d-none _header">
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <b><i>Address: #184 Purok 3, Ithan, Binangonan, Rizal</i></b><br>
                                                <b>Phone: +639279972636</b><br>
                                                <b>Email: swiftlinkitsolutions@gmail.com</b><br>
                                                <?php 
