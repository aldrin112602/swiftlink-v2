                            ...
                            <div class="d-flex align-items-center justify-content-end mb-4">
                                <div class="col col-lg-4 position-relative">
                                    <input type="search" style="padding-right: 2.5rem;" class="form-control"
                                        placeholder="Search" oninput="w3.filterHTML('#tablePreview', 'tr', this.value)">
                                    ...
                                    foreach ($dataToDisplay as $row) {
                                        ...
                                        <tr>
                                            <td class="ellipsis-text">
                                                ...
                                                &nbsp;&nbsp;&nbsp;&nbsp;<input id="item"
                                                    value="<?= $row['id'] ?? null ?>"
                                                    data-invoice="<?= $row['invoice'] ?? null ?>" type="checkbox">
                                            </td>
                                            ...
                                            <td class="ellipsis-text">
                                                ...
                                                <button class="fa-regular fa-trash-can text-danger btn btn-sm"
                                                    onclick="deleteConfirmation(<?= ($row['id'] ?? null) ?>, 'user_package')"></button>
                        ...
                        <form action="" method="POST" class="bg-white p-2 p-md-5" style="border-radius: 40px;">
                            ...
                            <div class="row px-3">
                                <div class="mb-3 px-2 col">
                                    ...
                                    <input type="month" name="from_month" id="from_month" class="form-control input"
                                        required>
                                </div>

                                <div class="mb-3 px-2 col">
                                    <label for="to_month" class="form-label">To:</label>
                                    <input type="month" name="to_month" id="to_month" class="form-control input"
                                        required>
                                </div>
                            </div>
                            <div class="mb-3 px-2 col">
                            ...
                            <div class="col-12 mt-5">
                                <button type="submit" class="btn btn-primary btn-lg px-5 text-white"
                                    style="border-radius: 20px;">Generate bill</button>
                            </div>
                        </form>
                        <script>
                        $(function() {
