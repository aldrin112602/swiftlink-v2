                    ...
                    <div class="container-fluid">
                        ...
                        <form action="" method="POST" class="bg-white p-2 p-md-5" style="border-radius: 40px;">
                            ...
                            <div class="mb-2">
                                ...
                                <input
                                    value="<?= $user_account['firstname'] ?> <?= $user_account['middle_initial'] ?> <?= $user_account['lastname'] ?>"
                                    type="text" readonly class="form-control">
                            </div>
                            <div class="mb-2">
                                <label for="" class="form-label">Account no.</label>
                                <input value="<?= $user_account['account_no'] ?>" type="number" readonly
                                    class="form-control">
                            </div>
                    ...
                    ?>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-2">
                            ...
                            <div class="d-flex align-items-center justify-content-end gap-3">
                                ...
                                <a href="?add_customer=true"
                                    class="btn btn-primary btn-lg px-4 text-white d-flex align-items-center justify-content-center gap-2"
                                    style="border-radius: 20px;"><i class="fa-solid fa-plus"></i> Add</a>
                            </div>
                        ...
                        <div class="table-responsive bg-white p-2 p-md-5" style="border-radius: 40px;">
                            <div class="d-flex align-items-center justify-content-between mb-4">
                                ...
                                <div class="col col-lg-4 position-relative">
                                    <input type="search" style="padding-right: 2.5rem;" class="form-control"
                                        placeholder="Search" oninput="w3.filterHTML('#table', 'tr', this.value)">
                            ...
                            <div class="table-responsive">
                                <table class="table table-white table-striped table-hover" id="table">
                                    <thead>
                                        <tr>
                                            <th class="ellipsis-text"
                                                scope="col d-flex align-items-center justify-content-start">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="ellipsis-text">
                                                ...
                                                <button class="fa-regular fa-user text-success btn btn-sm"
                                                    onclick="viewUser('<?= base64_encode($row['account_no']) ?>', 'accounts')"></button>
                        ...
                        <?php
                            ...
                            ?>
                        <form action="" enctype="multipart/form-data" method="POST" class="bg-white p-2 p-md-5"
                                ...
                                <div class="row">
                                    <div class="col my-2">
                                        <input autofocus placeholder="Email"
                                            value="<?php echo $_POST['email'] ?? null ?>" required type="email"
                                            class="form-control form-control-sm input" id="email" name="email">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="Phone" value="<?php echo $phone ?? null ?>" required
                                            type="number" class="form-control form-control-sm input" id="phone"
                                            name="phone">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Password" value="<?php echo $password ?? null ?>" required
                                            type="password" class="form-control form-control-sm input" id="password"
                                            name="password">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="Confirm Password"
                                            value="<?php echo $confirm_password ?? null ?>" required type="password"
                                            class="form-control form-control-sm input" id="Confirm_password"
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Firstname" value="<?php echo $firstname ?? null ?>" required
                                            type="text" class="form-control form-control-sm input" id="firstname"
                                            name="firstname">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="Middle Initial"
                                            value="<?php echo $middle_initial ?? null ?>" required type="text"
                                            class="form-control form-control-sm input" id="middle_Initial"
                                            name="middle_initial">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Lastname" value="<?php echo $lastname ?? null ?>" required
                                            type="text" class="form-control form-control-sm input" id="lastname"
                                            name="lastname">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="Address/House No./Street Name"
                                            value="<?php echo $address ?? null ?>" required type="text"
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Town" value="<?php echo $town ?? null ?>" required
                                            type="text" class="form-control form-control-sm input" id="town"
                                            name="town">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="City" value="<?php echo $city ?? null ?>" required
                                            type="text" class="form-control form-control-sm input" id="city"
                                            name="city">
                                    </div>
                                </div>
                            </div>
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Postal code" value="<?php echo $postal_code ?? null ?>"
                                            required type="text" class="form-control form-control-sm input"
                                            id="postal_code" name="postal_code">
                                    </div>

                                    <div class="col my-2">
                                        <input placeholder="Province" value="<?php echo $province ?? null ?>" required
                                            type="text" class="form-control form-control-sm input" id="province"
                                            name="province">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container my-3">
                                ...
                                <button id="fileBtn" type="button" class="btn btn-sm btn-success p-1 py-0"
                            ...
                            <div class="col-12 mt-5">
                                ...
                                <a href="./customer.php" class="btn btn-danger mx-3 btn-lg px-5 text-white"
                        ...
                        <form action="" enctype="multipart/form-data" method="POST" class="bg-white p-2 p-md-5"
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input autofocus placeholder="Email" value="<?php echo $row['email'] ?? null ?>"
                                            required type="email" class="form-control form-control-sm input" id="email"
                                            name="email">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="Phone" value="<?php echo $row['phone'] ?? null ?>" required
                                            type="number" class="form-control form-control-sm input" id="phone"
                                            name="phone">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col my-2">
                                        <input readonly placeholder="Password"
                                            value="<?php echo $row['password'] ?? null ?>" required type="text"
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Firstname" value="<?php echo $row['firstname'] ?? null ?>"
                                            required type="text" class="form-control form-control-sm input"
                                            id="firstname" name="firstname">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="Middle Initial"
                                            value="<?php echo $row['middle_initial'] ?? null ?>" required type="text"
                                            class="form-control form-control-sm input" id="middle_Initial"
                                            name="middle_initial">
                                    </div>
                                </div>
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Lastname" value="<?php echo $row['lastname'] ?? null ?>"
                                            required type="text" class="form-control form-control-sm input"
                                            id="lastname" name="lastname">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="Address/House No./Street Name"
                                            value="<?php echo $row['address']?? null ?>" required type="text"
                                            class="form-control form-control-sm input" id="address" name="address">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="container my-3">
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Town" value="<?php echo $row['town'] ?? null ?>" required
                                            type="text" class="form-control form-control-sm input" id="town"
                                            name="town">
                                    </div>
                                    <div class="col my-2">
                                        <input placeholder="City" value="<?php echo $row['city'] ?? null ?>" required
                                            type="text" class="form-control form-control-sm input" id="city"
                                            name="city">
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col my-2">
                                        <input placeholder="Postal code"
                                            value="<?php echo $row['postal_code'] ?? null ?>" required type="text"
                                            class="form-control form-control-sm input" id="postal_code"
                                            name="postal_code">
                                    </div>

                                    <div class="col my-2">
                                        <input placeholder="Province" value="<?php echo $row['province'] ?? null ?>"
                                            required type="text" class="form-control form-control-sm input"
                            ...
                            <div class="col-12 mt-5 d-flex align-items-center justify-content-end gap-3">
                                <a href="customer.php" class="btn btn-danger btn-lg px-5 text-white"
                                    style="border-radius: 20px;">Cancel</a>
                                <button type="submit" class="btn btn-primary btn-lg px-5 text-white"
                                    style="border-radius: 20px;">Save</button>
                            </div>
