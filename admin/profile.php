            ...
            <div class="dashboard-ecommerce">
                <div class="container-fluid dashboard-content ">
                    ...
                    <div class="ecommerse-widget">
                        ...
                        <form id="updateForm" action="" method="post" style="max-width: 900px; border-radius: 40px;"
                            class="form p-5 py-3 col-12 bg-white mx-auto">
                            ...
                            <img class="col-3 mx-auto d-block shadow rounded"
                                src="<?= $user[ 'profile' ] ?? 'https://www.oneeducation.org.uk/wp-content/uploads/2020/06/cool-profile-icons-69.png'  ?>"
                                alt="Profile">
                            <div class="d-flex align-items-center justify-content-center my-3">
                                <button type="button" id="profile2" class="btn btn-dark btn-sm"
                                    style="height: 40px; font-size: 12px;">Change profile</button>
                            </div>
                            ...
                            <div class="d-flex">
                                <div class="container my-2">
                                    ...
                                    <input name="firstname" value="<?= $data['firstname'] ?? null ?>" required
                                        type="text" class="form-control form-control-sm input" disabled>
                                </div>

                                <div class="container my-2">
                                    <label class="form-label">Last name</label>
                                    <input name="lastname" value="<?= $data['lastname'] ?? null ?>" required type="text"
                            ...
                            <div class="container my-2">
                                ...
                                <input name="email" value="<?= $data['email'] ?? null ?>" required type="email"
                                    class="form-control form-control-sm input" disabled>
                            </div>

                            <div class="container my-2">
                                <label class="form-label">Phone</label>
                                <input name="phone" value="<?= $data['phone'] ?? null ?>" required type="number"
                                    class="form-control form-control-sm input" disabled>
                            </div>

                            <div class="container my-2">
                                <label class="form-label">Address</label>
                                <input name="address" value="<?= $data['address'] ?? null ?>" required type="text"
                                    class="form-control form-control-sm input" disabled>
                            </div>

                            <div class="container my-2">
                                <label class="form-label">Password</label>
                                <input name="password" value="<?= $data['password'] ?? null ?>" required type="text"
                                    class="form-control form-control-sm input" disabled>
                            </div>

                            <div class="container mt-4">
                                <button id="editBtn" type="button"
                                    class="btn mb-3 btn-sm btn-primary px-5">Edit</button>
                                <button id="updateBtn" style="display: none;" type="submit"
                                    class="btn mb-3 btn-sm btn-success px-5 mx-2">Save Changes</button>
                            </div>
                            <script>
                            $(() => {
                                let state = true;
