                        ...
                        <div class="shadow p-5 bg-white" style="border-radius: 25px;">
                            <div class="mb-4 col-12 col-lg-3">
                                ...
                                <select class="form-select" name="help" id="help">
                                    ...
                                    <option value="Ticket"
                                        <?= ($_GET['help'] ?? null) == 'Ticket' ? 'selected' : null ?>>Ticket</option>
                                    <option value="Category"
                                        <?= ($_GET['help'] ?? null) == 'Category' ? 'selected' : null ?>>Category
                                    </option>
                                </select>
                            </div>
                            ...
                            <!-- ticket container -->
                            <div
                                class="container-fluid <?= (isset($_GET['help']) && $_GET['help'] == 'Ticket') || !isset($_GET['help']) ? '':'d-none' ?>">
                                <div class="row py-1">
                                            ...
                                            <div class="modal-body">
                                                <div class="container-fluid">
                                                    <div class="my-2">
                                                        ...
                                                        <input style="border-radius: 15px;" readonly
                                                    ...
                                                    <div class="my-2">
                                                        ...
                                                        <input style="border-radius: 15px;" readonly
                                                            class="form-control" name="report" id="report">
                                                    </div>
                                                    <div class="my-2">
                                                        <label for="remark">Remark</label>
                                                        <textarea style="border-radius: 15px;" readonly
                                                    ...
                                                    <div class="my-2">
                                                        ...
                                                        <img src="" alt="" srcset="" id="document" width="200px"
                                                            class="mx-auto d-block" height="200px"
                                                            style="object-fit: cover; border-radius: 15px;">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="modal-footer">
                                                <button id="markBtn" onclick="actionConfirmation('Mark as Process')"
                                                    type="button" class="btn btn-primary"
                                                    style="border-radius: 15px;">Mark as
                                                    Process</button>
                                                <button id="finishedBtn" onclick="actionConfirmation('Mark as Closed')"
                                                    type="button" class="btn btn-dark" style="border-radius: 15px;">Mark
                                                    as
                                                    Closed</button>
                                            </div>
                                        </div>
                                ...
                                <div class="table-responsive">
                                        ...
                                        <table class="table table-striped table-hover table-white"
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="py-0">
                                                    ...
                                                    <td class="">
                                                        <a onclick="showViewFileModal('<?= $row['id'] ?? null ?>')"
                                                            href="#" class="fas fa-folder"></a>
                                                        <i style="cursor: pointer;"
                                                            class="fa-solid fa-trash-can text-danger mx-2"
                                                            onclick="deleteConfirmation(<?= $row['id'] ?>, 'customer_ticket')"></i>
                                                    </td>
                                                </tr>
                                                <?php
                                                $count++;
                                    ...
                                    <nav aria-label="Page navigation">
                                        <ul class="pagination">
                                            ...
                                            <!-- Next page link -->
                                            <li
                                                class="page-item <?= ($current_page == $totalPages ? 'disabled' : '') ?>">
                                                <a class="page-link" href="?page=<?= ($current_page + 1) ?>"
                                                    aria-label="Next">
                            ...
                            <!-- Category container -->
                            <div
                                class="container-fluid <?= (isset($_GET['help']) && $_GET['help'] == 'Category') ? '':'d-none' ?>">
                                <!-- Add category Modal -->
                                <form action="" method="post" class="modal fade" id="addCategoryModal" tabindex="-1"
                                    role="dialog" aria-labelledby="addCategory" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content" style="border-radius: 25px;">
                                            ...
                                            <div class="modal-footer border-0">
                                                <button type="reset" class="btn px-4 btn-secondary"
                                                    data-bs-dismiss="modal" style="border-radius: 25px;">Close</button>
                                                <button type="submit" id="__submit_btn" class="btn px-4 btn-primary"
                                                    style="border-radius: 25px;">Add</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form action="" method="post" class="modal fade" id="updateCategoryModal" tabindex="-1"
                                    role="dialog" aria-labelledby="updateCategory" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content" style="border-radius: 25px;">
                                            <div class="modal-header px-4 border-0">
                                            ...
                                            <div class="modal-footer border-0">
                                                <button type="reset" class="btn px-4 btn-secondary"
                                                    data-bs-dismiss="modal" style="border-radius: 25px;">Close</button>
                                                <button type="submit" id="__submit_btn" class="btn px-4 btn-primary"
                                                    style="border-radius: 25px;">Save changes</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <form action="" method="post" class="modal fade" id="addHelpRemarksModal" tabindex="-1"
                                    role="dialog" aria-labelledby="addHelpRemarks" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content" style="border-radius: 25px;">
                                            <div class="modal-header px-4 border-0">
                                            ...
                                            <div class="modal-body border-0">
                                                <div class="container-fluid">
                                                    <div class="mb-3">
                                                        <label for="help" class="form-label">Help</label>
                                                        <input required type="text" class="form-control" name="help"
                                                            id="help">
                                                    </div>
                                ...
                                <form action="" method="post" class="modal fade" id="updateRemarksModal" tabindex="-1"
                                    role="dialog" aria-labelledby="updateRemarks" aria-hidden="true">
                                    <div class="modal-dialog modal-lg" role="document">
                                        <div class="modal-content" style="border-radius: 25px;">
                                            <div class="modal-header px-4 border-0">
                                ...
                                <div class="d-flex align-items-center justify-content-between py-2">
                                    ...
                                    <button data-bs-toggle="modal" data-bs-target="#addCategoryModal"
                                        class="btn btn-success px-5" style="border-radius: 25px;">Add</button>
                                </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between py-2">
                                    ...
                                    <button class="btn btn-success px-5" style="border-radius: 25px;"
                                        data-bs-toggle="modal" data-bs-target="#addHelpRemarksModal">Add</button>
                                </div>
                                <div style="min-height: 200px;">
                                    <table class="table table-striped table-hover table-white">
                                        <thead>
